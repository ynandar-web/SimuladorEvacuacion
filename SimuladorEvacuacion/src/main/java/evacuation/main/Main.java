...
/**
 * Punto de entrada del Simulador de Evacuación.
 * Responsabilidad: construir el grafo, registrar personas/zonas
 * y lanzar la simulación.
 *
 * Fase 1: Conceptos simples  ✓
 * Fase 2: Evacuación integrada ✓
 * Fase 3: Exportación .txt   ✓
 */
public class Main {
